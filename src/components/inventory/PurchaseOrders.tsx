        ...
        <CardContent>
          <div className="overflow-x-auto">
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead>{isSpanish ? 'Número de Orden' : 'Order Number'}</TableHead>
                  <TableHead>{isSpanish ? 'Proveedor' : 'Vendor'}</TableHead>
                  ...
                  <TableHead>{isSpanish ? 'Entrega Esperada' : 'Expected Delivery'}</TableHead>
              ...
              <TableBody>
                {filteredOrders.map((po) => (
                  <TableRow key={po.id}>
                    ...
                    <TableCell>
                      {isSpanish ? 
                        new Date(po.order_date).toLocaleDateString('es-ES') :
                          ...
                          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                            ...
                            <div className="space-y-6">
                              ...
                              <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                  <h4 className="font-medium text-sm text-muted-foreground">
                                    {isSpanish ? 'Fecha de Orden' : 'Order Date'}
                                  </h4>
                              ...
                              <div className="border-t pt-4">
                                <div className="flex justify-end">
                                  <div className="w-64 space-y-2">
                                    ...
                                    <div className="flex justify-between">
                                      <span>{isSpanish ? 'Impuesto:' : 'Tax:'}</span>
                                      <span>{formatCurrency(po.tax_amount)}</span>
                                    </div>
                                    <div className="flex justify-between">
                                      <span>{isSpanish ? 'Envío:' : 'Shipping:'}</span>
