            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select 
                  ...
                  onValueChange={(value: string) => setFormData(prev => ({ ...prev, plan_type: value }))}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <Select 
                  ...
                  onValueChange={(value: string) => setFormData(prev => ({ ...prev, priority_level: value }))}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
            ...
            <div className="space-y-4">
              ...
              {selectedPlan.plan_steps && selectedPlan.plan_steps.length > 0 && (
                <div>
                  ...
                  <div className="space-y-2 mt-2">
                    {selectedPlan.plan_steps.map((step: string | { description: string }, index: number) => (
              ...
              {selectedPlan.emergency_contacts && selectedPlan.emergency_contacts.length > 0 && (
                <div>
                  <Label>Emergency Contacts</Label>
                  <div className="space-y-2 mt-2">
                    {selectedPlan.emergency_contacts.map((contact: { name: string; role?: string; phone?: string; email?: string }, index: number) => (
