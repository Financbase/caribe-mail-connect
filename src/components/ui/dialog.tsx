...
// Context to wire aria-labelledby/aria-describedby
...
const DialogA11yContext = React.createContext<DialogA11yContextValue>({
  setTitleId: () => {},
  setDescriptionId: () => {}
})
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <DialogPortal>
      <DialogOverlay />
      <DialogA11yContext.Provider value={{ titleId, descriptionId, setTitleId, setDescriptionId }}>
